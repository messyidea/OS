...
void HariMain(void)
{
    ...
    fifo32_init(&keycmd, 32, keycmd_buf, 0);    //键盘
	...
	fifo.task = task_a;
	task_run(task_a, 1, 2);
    *((int *) 0x0fe4) = (int) shtctl;   //便于console使用
